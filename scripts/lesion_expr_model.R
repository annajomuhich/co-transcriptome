...
lesion_path <- "~/UCDavis/Klieb_Lab/Projects/Fabaceae/Fab_Manuscript/data/Pheno/cucfab_lsm.csv"
bcin_expr_path <- "remove_7isos/bcin_genemodel_may2/bcin_adjusted_emmeans.csv"
...
expr <- left_join(bcin_expr, pv_expr, by = c("iso_name", "genotype"))
expr <- left_

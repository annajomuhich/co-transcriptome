...
hostrep1_path <- "raw_reads/badQC_removed/UCC1/Host_readcounts.csv"
hostrep2_path <- "raw_reads/badQC_removed/UCC2/Host_readcounts.csv"
hostrep3_path <- "raw_reads/badQC_removed/UCC3/Host_readcounts.csv"
bcinrep1_path <- "raw_reads/badQC_removed/UCC1/Bcin_readcounts.csv"
bcinrep2_path <- "raw_reads/badQC_removed/UCC2/Bcin_readcounts.csv"
bcinrep3_path <- "raw_reads/badQC_removed/UCC3/Bcin_readcounts.csv"
####
...
dir.create("normalized_counts/Pv/")
setwd("normalized_counts/Pv/")
